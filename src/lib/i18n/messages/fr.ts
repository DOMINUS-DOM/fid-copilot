...
const messages: Messages = {
  ...
  narrative: {
    sectionTitle: "Votre cadre. Votre assistant.",
    sectionSubtitle: "Comment ça marche",
    scenes: {
      complexity: {
        title: "Chaque décision repose sur des règles complexes",
        subtitle: "Chaque établissement fonctionne avec ses propres règles, procédures et contraintes.",
      },
      chaos: {
        title: "Des règles propres à chaque école",
        subtitle: "Appliquer ce cadre au quotidien est complexe, chronophage... et parfois risqué.",
        labels: ["PDF", "DOCX", "Fiche", "Extrait", "Note"],
      },
      appear: {
        subtitle: "Le copilote juridique des directions d'école",
        tagline: "Un assistant conçu pour accompagner les directions.",
      },
      import: {
        badge: "Import de vos documents",
        title: "Vos documents. Votre cadre.",
        files: ["Reglement-ecole.pdf", "ROI.docx", "Procedures-internes.pdf"],
      },
      adapt: {
        title: "Une IA qui s'adapte à votre réalité",
        keyMessage: "FID Copilot s'adapte à votre règlement. Il ne le remplace pas.",
      },
      generate: {
        title: "Des réponses structurées et conformes",
      },
      secure: {
        title: "Sécurisation juridique",
        subtitle: "Chaque réponse est construite pour réduire les risques et sécuriser vos décisions.",
        badges: ["Sources vérifiables", "Cadre légal respecté", "Traçabilité"],
      },
      difference: {
        title: "Pas de standardisation. Une adaptation intelligente.",
        genericLabel: "IA générique",
        copilotLabel: "FID Copilot",
        genericPoints: ["Même réponse pour tous", "Pas de contexte école", "Aucune traçabilité"],
        copilotPoints: ["Adapté à votre école", "Vos documents intégrés", "Sources vérifiables"],
      },
      conclusion: {
        title: "Décidez avec confiance",
        subtitle: "Un cadre plus clair. Des décisions mieux sécurisées.",
        badges: ["Chaque école a son propre cadre", "FID Copilot s'adapte, il ne remplace pas", "Réponses structurées et sécurisées"],
      },
    },
    structureLabels: ["Identification du problème", "Règle juridique", "Application concrète", "Conclusion"],
  },
  demoAssistant: {
    sectionLabel: "Assistant juridique",
    sectionTitle: "Posez votre question, obtenez la base légale",
    scenarios: [
      {
  ...
  demoDocument: {
    sectionLabel: "Générateur de documents",
    sectionTitle: "Du besoin au document officiel, en quelques secondes",
    inputPlaceholder: "Décrivez votre situation",
    typedText: "Un élève a été exclu, je dois rédiger un courrier officiel",
    analyzeLabel: "Analyse en cours...",
    analyzeSteps: ["Situation identifiée", "Cadre légal détecté", "Type de document : courrier"],
    generateLabel: "Génération du document...",
    docHeader: "Athénée Royal des Collines",
    docAddress: "Avenue de l'Europe, 12 — 1348 Louvain-la-Neuve",
    docSubject: "Objet : Notification d'exclusion définitive",
    docBody: [
      "Madame, Monsieur,",
      "Nous vous informons par la présente de la décision d'exclusion définitive concernant votre enfant...",
      "Cette décision a été prise après audition et examen des faits.",
    ],
    legalHighlight: "Conformément aux articles 1.7.9.4 à 1.7.9.6 du Code de l'enseignement, cette décision a été prise dans le respect de la procédure légale.",
    legalBadgeTitle: "Base légale vérifiée",
    legalBadgeRef: "Code de l'enseignement — Art. 1.7.9.4 à 1.7.9.6",
    legalHighlight2: "L'élève et ses responsables ont été entendus conformément au droit d'audition prévu par la procédure.",
    interactTitle: "Personnalisez votre document",
    interactButtons: ["Modifier", "Adapter", "Simplifier", "Ajouter"],
    interactVariants: [
    ...
    exportButton: "Générer PDF",
    exportSuccess: "Document prêt à envoyer",
  },
};
