...
export const FID_COVERAGE_MATRIX: CoverageCase[] = [
  ...
  },
  {
    ...
    tested: true,
    confidence: "secured",
    remarks: "Art. 1er §2 corrigé (paragraph: 2). Pivot multi-chunk (limit 3). Scoring §2 > §1 par ratio lexical.",
  },
  {
    id: "daspa",
  ...
  },
  {
    ...
    name: "Orientation des études D2 — technique de transition",
    theme: "Structure secondaire",
    cdaCode: "10450",
    pivotArticles: ["5"],
    presence: true,
    routing: true,
    ...
    tested: true,
    confidence: "secured",
    remarks: "Article 5 §3 présent (chunk 540a6153). Pivot 'orientation/D2/OBG/transition' ajouté. Confiance dégradée si citation guard flagge.",
  },
  {
